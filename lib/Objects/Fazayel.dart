class FazayelObj {
  String FazayelTableName = 'Fazayel';
  String columnId = 'id';
  String columnDate = 'Date';
  String columnBishesDua = 'BishesDua';
  String column4_Jon_Golam = 'Char_Jon_Golam';
  String column_10_Golam_100_Neki = 'Dosh_Golam_Eksho_Neki';
  String column_Somudrer_Fena = 'Somudrer_Fena';
  String column_Mizaner_Palla = 'Mizaner_Palla';
  String column_1000_Neki = 'Hajar_Neki';
  String column_Jannater_Guptodhon = 'Jannater_Guptodhon';
  String column_70_Onisto = 'Sottur_Onisto';
  String column_Sorbosrestho_Dua = 'Sorbosrestho_Dua';
  String column_Sorbottom_Jikr = 'Sorbottom_Jikr';
  String column_Chiroyesthayee_Nek_Amal = 'Chiroyesthayee_Nek_Amal';
  String column_Quran_Ek_tritiyo = 'Quran_Ek_tritiyo';
  String column_Beshi_Beshi_Ikhlash = 'Beshi_Beshi_Ikhlash';
  String column_Suparish = 'Suparish';
  String column_Raat_E_Bakara = 'Raat_E_Bakara';
  String column_Ekti_Sorner_Prashadh = 'Ekti_Sorner_Prashadh';
  String column_Jahannam_Mukti_Swarner_Gach = 'Jahannam_Mukti_Swarner_Gach';
  String column_Jannate_Ekti_Khajur_Gach = 'Jannate_Ekti_Khajur_Gach';
  String column_Jannat_Lav_Jahannam_Mukti = 'Jannat_Lav_Jahannam_Mukti';
  String column_Deen_Otol_Thaka = 'Deen_Otol_Thaka';
  String column_Islam_Otol_Thaka = 'Islam_Otol_Thaka';
  String column_Gunah_Maf_Chaowa = 'Gunah_Maf_Chaowa';
  String column_Rasul_Istigfar = 'Rasul_Istigfar';
  String column_Rasul_Istigfar_Mrittur_Agee = 'Rasul_Istigfar_Mrittur_Agee';
  String column_Darud_Pathh = 'Darud_Pathh';
}
...
List<Map<String, dynamic>> Qadr_Data = [
  ...
  // },
  {
    'id': fazayel.column_Jannat_Lav_Jahannam_Mukti,
