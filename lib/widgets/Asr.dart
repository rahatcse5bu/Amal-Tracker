...
class Asr extends StatefulWidget {
  Asr({super.key, required this.amal_date, required this.id});
  String amal_date;
  String id;
  @override
...
class _AsrState extends State<Asr> {
  ...
  initState() {
    ...
    dbHelper
        .initializeData('Asr', widget.amal_date.toString())
        .then((value) => setState(() {
                  ...
                  Card(
                      ...
                      child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            for (var i = 0;
                                i < dbHelper.modifiedAsrItems.length;
                                i++) ...[
                              dbHelper.modifiedAsrItems.length > 0
                                  ? SwitchListTile(
                                      secondary: dbHelper.modifiedAsrItems[i]
                                                  ['isChecked'] ==
                                              false
                                          ? Icon(
                                              Icons.close,
                                      ...
                                      activeColor: dbHelper.modifiedAsrItems[i]
                                                  ['isChecked'] ==
                                              false
                                          ? Colors.red
                                      ...
                                      title: RichText(
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            TextSpan(
                                              text: dbHelper.modifiedAsrItems[i]
                                                  ['title'],
                                              style: TextStyle(
                                                  color: Colors.black),
                                            ),
                                      ...
                                      value: dbHelper.modifiedAsrItems[i]
                                          ['isChecked'],
