...
class Maghrib extends StatefulWidget {
  Maghrib({super.key, required this.amal_date, required this.id});
  String amal_date;
  String id;
  @override
...
class _MaghribState extends State<Maghrib> {
  ...
  initState() {
    ...
    dbHelper
        .initializeData('Maghrib', widget.amal_date.toString())
        .then((value) => setState(() {
                  ...
                  Card(
                      ...
                      child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            for (var i = 0;
                                i < dbHelper.modifiedMaghribItems.length;
                                i++) ...[
                              dbHelper.modifiedMaghribItems.length > 0
                                  ? SwitchListTile(
                                      secondary:
                                          dbHelper.modifiedMaghribItems[i]
                                                      ['isChecked'] ==
                                                  false
                                              ? Icon(
                                                  Icons.close,
                                      ...
                                      value: dbHelper.modifiedMaghribItems[i]
                                          ['isChecked'],
