...
class Dhuhr extends StatefulWidget {
  Dhuhr({super.key, required this.amal_date, required this.id});
  String amal_date;
  String id;
  @override
...
class _DhuhrState extends State<Dhuhr> {
  ...
  initState() {
    ...
    dbHelper
        .initializeData('Dhuhr', widget.amal_date.toString())
        .then((value) => setState(() {
              // print('value----------------: ' + value.toString());
              dbHelper.modifiedDhuhrItems = value;
            }));
  }
  ...
  Widget build(BuildContext context) {
    ...
    .format(DateTime.parse(widget.amal_date))}'),
        centerTitle: true,
                ...
                Card(
                    ...
                    child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          for (var i = 0;
                              i < dbHelper.modifiedDhuhrItems.length;
                              i++) ...[
                            dbHelper.modifiedDhuhrItems.length > 0
                                ? SwitchListTile(
                                    secondary: dbHelper.modifiedDhuhrItems[i]
                                                ['isChecked'] ==
                                            false
                                        ? Icon(
                                            Icons.close,
                                    ...
                                    activeColor: dbHelper.modifiedDhuhrItems[i]
                                                ['isChecked'] ==
                                            false
                                        ? Colors.red
                                    ...
                                    title: RichText(
                                      text: TextSpan(
                                        ...
                                        children: <TextSpan>[
                                          TextSpan(
                                            text: dbHelper.modifiedDhuhrItems[i]
                                                ['title'],
                                            style:
                                    ...
                                    value: dbHelper.modifiedDhuhrItems[i]
                                        ['isChecked'],
