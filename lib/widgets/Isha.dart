...
class Isha extends StatefulWidget {
  Isha({super.key, required this.amal_date, required this.id});
  String amal_date;
  String id;
  @override
...
class _IshaState extends State<Isha> {
  ...
  initState() {
    ...
    dbHelper
        .initializeData('Isha', widget.amal_date.toString())
        .then((value) => setState(() {
                  ...
                  Card(
                      ...
                      child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            for (var i = 0;
                                i < dbHelper.modifiedIshaItems.length;
                                i++) ...[
                              dbHelper.modifiedIshaItems.length > 0
                                  ? SwitchListTile(
                                      secondary: dbHelper.modifiedIshaItems[i]
                                                  ['isChecked'] ==
                                              false
                                          ? Icon(
                                              Icons.close,
                                      ...
                                      activeColor: dbHelper.modifiedIshaItems[i]
                                                  ['isChecked'] ==
                                              false
                                          ? Colors.red
                                      ...
                                      value: dbHelper.modifiedIshaItems[i]
                                          ['isChecked'],
